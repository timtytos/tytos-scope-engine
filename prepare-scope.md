...
- Lies `crucible/domains/INDEX.md` für das Keyword-Mapping
- Für JEDEN identifizierten Feature-Typ: Lies den passenden Blueprint aus `crucible/domains/`
...
```bash
claude "Lies crucible/prepare-scope.md als deine Instruktionen. Dann lies brief.md und alle relevanten Blueprints aus crucible/domains/. Generiere .farm/scope-contract.json und .farm/scope-summary.md."
```
